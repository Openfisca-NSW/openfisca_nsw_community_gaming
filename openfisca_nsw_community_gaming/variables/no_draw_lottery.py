...
class no_draw_lottery__game_meets_criteria(Variable):
    ...
    def formula(organisation, period, parameters):
        return (
            ...
            * organisation('gaming_activity_is_no_draw_lottery', period) * (organisation('total_prize_value_of_all_prizes_from_gaming_activity', period) <= parameters(period).permitted_games.no_draw_lottery.max_total_value_of_all_prizes)
